...
public class ListeFilieres extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListeFilieres frame = new ListeFilieres();
...
public void RechercheF() {
		
		
		String nom = rechercheField.getText().toString();
		String sql = "SELECT * FROM filiere WHERE nom = ?";
		try {
			if (!nom.equals("")) {
